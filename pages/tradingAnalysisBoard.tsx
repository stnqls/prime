...
const TradingAnalysisBoard: NextPage = () => {
  ...
  function getData(pageNumber: any) {
    ...
    axios({
      method: "GET",
      url: `https://us-central1-prime-investment-web.cloudfunctions.net/api/community?categoryCode=201&page=${pageNumber}&order=${order}&search=${search}`,
    })
      .then((res) => {
        if (res.data.success) {
...
export default TradingAnalysisBoard;
