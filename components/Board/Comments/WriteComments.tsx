...
import "./WriteComments.scss";

const WriteComments = (props: any) => {
  ...
  return (
    <div className="comments__write">
      <div className="comments__write__box">
        <div className="comments__write__box__name">{nickname}</div>
        {/* <span
          id="textarea"
          role="textbox"
          className="comments__write__box__text"
          contentEditable
        ></span> */}
        <textarea
          className="comments__write__box__text"
        ...
        <button
          type="button"
          className="comments__write__box__submit"
          onClick={() => {
            if (Lee.checkLogin()) {
              writeReply();
            } else {
      ...
      <textarea
        className="comments__write__mtext"
        placeholder="내용을 입력하세요"
        onChange={(e) => content(e.target.value)}
      ></textarea>
      <button
        type="button"
        className="comments__write__msubmit"
        onClick={() => {
          if (Lee.checkLogin()) {
            writeReply();
          } else {
